...
Cuando se use este archivo LaTeX como contexto, Codex debe:
...
Usa este archivo LaTeX como unica fuente normativa.
...
\begin{itemize}
    ...
    \item que articulos de este archivo justifican cada recomendacion.
\end{itemize}

No inventes jurisprudencia ni normativa no incluida en este archivo.
