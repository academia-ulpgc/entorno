...
\section*{Usar Copilot con contexto en LaTeX}
...
\begin{itemize}
    ...
    \item[$\square$] He probado una pregunta vaga a Copilot.
    \item[$\square$] He probado una pregunta con contexto y condiciones.
    \item[$\square$] He revisado si Copilot ha inventado informacion no incluida en el LaTeX de contexto.
